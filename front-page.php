...
<div class="container">
	<section class="banner">
		...
		<div class="span6 banner-photo pull-right">
			<img class="pull-right" src="<?php echo THEME_IMAGES; ?>temp/banner.jpg">
		</div>
		...
		<div class="clearFix">
			<img src="<?php echo THEME_IMAGES; ?>backgrounds/960-shadow.png" style="width: 100%;"alt="" />
		</div>

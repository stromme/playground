...
<section class="bg-slate">
	<div class="row-fluid bumper-top-large bumper-bottom single-project project">
      ...
      <?php
      $comments = get_comments(array('post_id'=>$prj->id, 'status'=>'approve'));
      $reviews = array();
      ...
      ?>
			...
			<ul class="share-it">
				...
				<li class="social-network sc-twitter"><a href="https://twitter.com/share" class="twitter-share-button" data-via="streakfreeclean" data-related="streakfreeclean" data-hashtags="WindowCleaning">Tweet</a>

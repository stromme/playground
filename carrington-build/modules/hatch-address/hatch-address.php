    ...
    private $default_title = 'Come say hello...';
		...
		public function __construct() {
			$opts = array(
				...
				'icon' => 'hatch-address/icon.png'
			);
			parent::__construct('cfct-module-hatch-address', __('.: Hatch Address :.', 'carrington-build'), $opts);
		}
...
// Display
	...
	cfct_build_register_module('cfct_module_hatch_address');
}
?>

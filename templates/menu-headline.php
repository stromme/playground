	...
	<div class="container headline">
		<ul>
			<li class="headline-title green-man-45">
				<h1 itemprop="description" itemscope="http://schema.org/PostalAddress"><span class="hidden-phone-portrait">Awarded <?=date('Y')?></span> <b>Best Window Cleaners</b> in <a href="<?=get_home_url().get_blog_prefix()."/locations/"?>" class="link-inverse link-decorate link-showoff" data-toggle="tooltip" data-placement="bottom" title="Visit another location" itemprop="addressLocality"><?=$seo['city']?><span class="hidden-phone-portrait" itemprop="addressRegion"><?=($seo['state']!='')?', '.$seo['state']:''?></span></a></h1>
			</li>

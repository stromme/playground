	...
	<div class="container headline">
		<ul>
			...
			<li class="headline-phone">
				...
				<h2 class="white" itemprop="telephone"><span class="visible-phone-portrait"><?=esc_html( stripslashes($tb_company['name']))?></span> <a href="tel:<?=tb_format_phone_plain(get_phone_number())?>" class="link-inverse link-decorate link-showoff"><?=get_phone_number()?></a></h2>
			</li>

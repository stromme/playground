...
<!-- Review Modal -->
<div class="modal fade hide" id="new-review">
	...
	<div class="modal-body">
		...
		<div class="row-fluid bumper-top-small hide">
			<div class="span6">
				<div class="input-prepend">
				    <span class="add-on"><i class="icon-user"></i></span>
				    <input class="input-block-level" validation="email" placeholder="Your Name" type="text">
				</div>
			</div>
			<div class="span6">
				<div class="input-prepend">

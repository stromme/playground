...
<div class="share-project-template hide">
	...
	<div class="share-body">
      ...
      <label for="customer-message">Email message</label>
			<textarea class="input-block-level" id="customer-message" placeholder="Message to customer" validation="not-empty" rows="5">We just finished your {project-slug}project and wanted to share with you how great things turned out. Here's a few photo's of the completed work. Let us know if you need anything else.</textarea>
		</div>

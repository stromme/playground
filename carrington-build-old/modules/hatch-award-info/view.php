<?php
/**
 * Description: Award Info Module - default view.
 * A module to display block of award information.
 *
 * @package
 * @subpackage
 * @since
...
<div class="well-blue well well-has-shadow">
	<div class="clearfix">
		...
		<div class="center">
			<div class="btn-group">
				<a href="tel:<?=tb_format_phone_plain(get_phone_number())?>" class="btn btn-primary btn-large hidden-phone">Call us <?=get_phone_number()?></a>
